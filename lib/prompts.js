/**
 * NOTE: This module looks unused/stale — the API routes define their own
 * inline prompt maps (`moodPrompts` in summarize, `flashcardPrompts` in
 * flashcards, and route-local chat prompts). Keep in sync if it is actually
 * referenced, or delete it.
 */
